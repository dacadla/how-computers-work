...
<body>
  ...
  <main>
        ...
        <section>
            <h2>Get Started</h2>
            <p>
                Ready to begin your journey into the world of computers? Start exploring our lessons and articles to gain a better understanding of computer hardware, software, and programming. When you're ready to test your knowledge, take our interactive quizzes by clicking the "Start Quiz" button below.
            </p>
            <p>
                Whether you're a curious student or simply interested in learning how computers work, you'll find valuable resources and interactive content here.
            </p>
            <a href="pages/hardware.php" class="button">Start Quiz</a>
        </section>
    </main>
